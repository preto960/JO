    ...
    <div class="w-full max-w-md p-8">
      <div class="bg-white dark:bg-gray-800 p-8 rounded-lg border border-gray-200 dark:border-gray-700 shadow-lg">
        <div class="text-center mb-8">
          ...
          <h1 class="text-3xl font-bold text-gray-900 dark:text-white mb-2">Publisher Account</h1>
          <p class="text-sm text-gray-600 dark:text-gray-300">Create your publisher profile</p>
        </div>
