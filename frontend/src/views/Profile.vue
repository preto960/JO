      ...
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between items-center h-16">
          <div class="flex items-center space-x-8">
            <router-link to="/marketplace" class="text-xl font-bold text-primary-600">
              Plugin Marketplace
            </router-link>
            <nav class="hidden md:flex space-x-8">
              <router-link to="/marketplace" class="text-gray-600 hover:text-gray-900">
                Marketplace
              </router-link>
              <router-link to="/profile" class="text-gray-900 font-medium">
                Profile
              </router-link>
              <router-link v-if="user?.role === 'DEVELOPER'" to="/dashboard" class="text-gray-600 hover:text-gray-900">
                Dashboard
              </router-link>
            </nav>
          </div>
