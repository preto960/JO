<template>
  <div class="space-y-6">
    <!-- Profile Settings -->
    <div class="card">
      <h3 class="text-xl font-bold text-gray-900 dark:text-white mb-6">Profile Settings</h3>
    ...
    <div class="card">
      ...
      <div class="space-y-4">
        <div class="flex items-center justify-between p-4 bg-gray-100 dark:bg-gray-700/30 rounded-lg">
          <div>
            <p class="text-gray-900 dark:text-white font-medium">Auto-update Plugins</p>
            <p class="text-gray-500 dark:text-gray-400 text-sm">Automatically update plugins when new versions are available</p>
          </div>
        ...
        <div class="flex items-center justify-between p-4 bg-gray-100 dark:bg-gray-700/30 rounded-lg">
          <div>
            ...
            <p class="text-gray-500 dark:text-gray-400 text-sm">Receive email notifications for system events</p>
          </div>
          <label class="relative inline-flex items-center cursor-pointer">
        ...
        <div class="flex items-center justify-between p-4 bg-gray-100 dark:bg-gray-700/30 rounded-lg">
          <div>
            ...
            <p class="text-gray-500 dark:text-gray-400 text-sm">Use dark theme for the interface</p>
          </div>
          <label class="relative inline-flex items-center cursor-pointer">
